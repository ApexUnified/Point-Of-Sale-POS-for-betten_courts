...
class SaleController extends Controller
{
    ...
    public function printLastReciept()
    {
        ...
        if (empty($sale)) {
            Toastr()->error("Please Sale Atleast One Product Before Printing Invoice");
            return redirect()->back();
        }
    ...
    public function genInvoice($id)
    {
        ...
        if ($lims_pos_setting_data->invoice_option == 'A4') {
            ...
            return view('backend.sale.invoice', compact('lims_sale_data', 'warehouse', 'currency_code', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'sale_custom_fields', 'customer_custom_fields', 'product_custom_fields', 'qrText', 'totalDue'));
        }
    }



    public function genInvoiceKitchen($id)
    {
        $lims_sale_data = Sale::find($id);
        $warehouse = Warehouse::find($lims_sale_data->warehouse_id);
        $lims_product_sale_data = Product_Sale::where('sale_id', $id)->get();
        ...
        if ($lims_pos_setting_data->invoice_option == 'A4') {
            ...
            return view('backend.sale.kitchen_invoice', compact('lims_sale_data', 'warehouse', 'currency_code', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'sale_custom_fields', 'customer_custom_fields', 'product_custom_fields', 'qrText', 'totalDue'));
        }
    }
