...
class WarehouseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($request->image)){
            ...
            $directory = public_path("images/warehouse_images");
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($request->image)){
            ...
            if(!empty($lims_warehouse_data->image)){
                File::delete(public_path("images/warehouse_images/" . $lims_warehouse_data->image));
            }
