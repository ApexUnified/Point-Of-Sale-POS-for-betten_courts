...
class ReportController extends Controller
{
    ...
    public function attendance_report(Request $request){
        ...
        $start_date = $request->input('start_date') ?: Carbon::parse($request->input('start_date'));
        $end_date = $request->input('end_date') ?: Carbon::parse($request->input('end_date'));
        ...
        if($start_date && $end_date){
            $attendances->whereDate('date', '>=', $start_date)->whereDate('date', '<=', $end_date);
        }
        
        $attendances = $attendances->select(
            'employee_id',
            'date',
            DB::raw('GROUP_CONCAT(DISTINCT CONCAT(checkin, " - ", IFNULL(checkout, "N/A")) ORDER BY checkin ASC SEPARATOR "\n") as times'),
        ...
        // return $attendances;
        // dd(DB::getQueryLog());
        return view('backend.report.attendanceReport',compact('attendances','start_date','end_date'));
    }
}
