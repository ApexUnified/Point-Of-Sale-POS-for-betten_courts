...
use App\Http\Controllers\OutOfShiftsController;
...
use App\Http\Controllers\zktecoConfigController;
...
Route::get("order-invoice/{refference}", [OrderInvoiceController::class, "Invoice"])->name("order.invoice");
Auth::routes();
...
Route::group(['middleware' => ['common', 'auth', 'active']], function () {
    ...
    Route::controller(StockTransferController::class)->group(function () {
        Route::get("/stock-trannsfer/{id}", "index")->name("stock-trannsfer.index");
        Route::get("/stock-transfer/ids/{from_warehouse_id}/{to_warehouse_id}/{product_id}", "stock_transfer");
        Route::post("/stock-transfer/towarehouse", "stock_transfer_towarehouse")->name("stock_transfer_to_warehouse");
    });
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('sales/gen_invoice/kitchen/{id}', 'genInvoiceKitchen')->name('sale.invoice.kitchen');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            Route::get('attendance_report', 'attendance_report')->name('attendance.report');
    ...
    Route::controller(SettingController::class)->group(function () {
        Route::prefix('setting')->group(function () {
            ...
            Route::get('hrm_shift_create', 'hrmshiftcreate')->name('setting.hrm.shift');
            Route::post('hrm_shift_create/post', 'hrmshiftcreatePost')->name('setting.hrm.shift.post');
            Route::get('hrm_shift_edit/{id}', 'hrmshiftedit')->name('setting.hrm.edit');
            Route::put('hrm_shift_update/{id}', 'hrmshiftupdate')->name('setting.hrmupdate');
            Route::get('hrm_shift_delete/{id}', 'hrmshiftdelete')->name('setting.hrm.shift.delete');
    ...
    Route::controller(IncomeCategoryController::class)->group(function () {
        ...
        Route::post('income_categories/deletebyselection/{id}', 'deleteBySelection');
    ...
    Route::post('money_transfers/deletebyselection', [MoneyTransferController::class,  'MoneydeleteBySelection'])->name('deleteMoneyTransfer');
    ...
    Route::get('out-of-shifts', [OutOfShiftsController::class, 'index'])->name('out.of.shift');

    // ZK Routes
    Route::get('/zk/device/check', [EmployeeController::class, 'zkdeviceCheck'])->name('zkdeviceCheck');
    Route::get('/poll/zk/device', [AttendanceController::class, 'pollZkDevice'])->name('pollZkDevice');
    Route::get('/zkteco/config', [zktecoConfigController::class, 'zktecoConfig'])->name('zkteco.config');
    Route::get('/zkteco/create', [zktecoConfigController::class, 'zkCreate'])->name('zk.create');
    Route::post('/zkteco/create/post', [zktecoConfigController::class, 'zkCreatePost'])->name('zk.create.post');
    Route::get('/zkteco/edit/{id}', [zktecoConfigController::class, 'zkEdit'])->name('zk.edit');
    Route::put('/zkteco/update/{id}', [zktecoConfigController::class, 'zkEditPost'])->name('zk.edit.post');
    Route::get('/zkteco/delete/{id}', [zktecoConfigController::class, 'zkDelete'])->name('zk.delete');
    // ZK Routes
    ...
    Route::get('/employee/shifts/{id}', [AttendanceController::class, 'getShiftEmployee'])->name('employeeShift');
    // Get Shifts Of Employees
