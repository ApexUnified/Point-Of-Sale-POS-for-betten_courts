...
<html dir="rtl">
  <head>
    ...
    <!-- Google fonts - Roboto -->
    <link rel="preload" href="{{ asset("css/googlefontapis.css") }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    <link rel="preload" href="{{ asset("css/datatablesFixedheaders.css") }}"
   as="style" onload="this.onload=null;this.rel='stylesheet'">
  <noscript>
    <link href="{{ asset("css/datatablesFixedheaders.css") }}" rel="stylesheet">
  </noscript>
  <link rel="preload" href="{{ asset("css/datatablesResponsive.css") }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <noscript>
