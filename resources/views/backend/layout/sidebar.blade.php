                    ...
                    <ul id="product" class="collapse list-unstyled ">
                        ...
                        @if ($adjustment_active)
                            <li id="adjustment-list-menu"><a
                                    href="{{ route('qty_adjustment.index') }}">{{ trans('Adjustment List') }}</a>
                            </li>
                            <li id="adjustment-create-menu"><a
                                    href="{{ route('qty_adjustment.create') }}">{{ trans('Adjustment Add') }}</a>
                            </li>
                        @endif
                        ...
                        @endif
                        <li id="stock-transfer-menu"><a href="#"
                                id="stock-transfer">{{ trans('Stock Transfer') }}</a></li>
                    </ul>
                </li>
            @endif
            <?php
            ...
            @if ($department_active || $index_employee_active || $attendance_active || $payroll_active || $holiday_active)
                <li class=""><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="hrm" class="collapse list-unstyled ">
                        ...
                        @php
                            $out_of_shift_permission_active = $role_has_permissions_list
                                ->where('name', 'out_of_shift')
                                ->first();
                        @endphp

                        @if ($out_of_shift_permission_active)
                            <li id="out-of-shifts-menu"><a
                                    href="{{ route('out.of.shift') }}">{{ trans('Out Of Shits Employees') }}</a></li>
                        @endif
                ...
                <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="report" class="collapse list-unstyled ">
                        ...
                        <li id="attendance-report-menu">
                            <a href="{{ route('attendance.report') }}">{{ trans('Attendance Report') }}</a>
                        </li>
                        ...
                        @if ($warehouse_report_active)
                            <li id="warehouse-report-menu">
                                <a id="warehouse-report-link" href="">{{ trans('Branch Report') }}</a>
                            </li>
                        @endif
                        @if ($warehouse_stock_report_active)
                            <li id="warehouse-stock-report-menu">
                                <a
                                    href="{{ route('report.warehouseStock') }}">{{ trans('Branch Stock Chart') }}</a>
                            </li>
                        @endif
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @if ($warehouse_permission_active)
                        <li id="warehouse-menu"><a href="{{ route('warehouse.index') }}">{{ trans('Branch') }}</a>
                        </li>
                    @endif
                    ...
                    @php
                        $zkteco_config_permission_active = $role_has_permissions_list
                            ->where('name', 'zkteco_configuration')
                            ->first();
                    @endphp

                    @if ($zkteco_config_permission_active)
                        <li id="zkteco-config"><a href="{{ route('zkteco.config') }}">
                                {{ trans('ZkTeco Configuration') }}</a></li>
                    @endif
