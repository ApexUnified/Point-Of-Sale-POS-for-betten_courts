...
<html>
  <head>
    ...
    <!-- Google fonts - Roboto -->
    <link rel="preload" href="{{ asset("css/googlefontnunito.css") }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="{{ asset("css/googlefontnunito.css") }}" rel="stylesheet"></noscript>
    <!-- jQuery Circle-->
