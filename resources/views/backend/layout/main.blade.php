...
<head>
    ...
    @if (!config('database.connections.saleprosaas_landlord'))
        ...
        @if (Route::current()->getName() != '/')
            ...
            <link rel="preload" href="{{ asset('css/datatablesFixedheaders.css') }}" as="style"
                onload="this.onload=null;this.rel='stylesheet'">
            <noscript>
                <link href="{{ asset('css/datatablesFixedheaders.css') }}" rel="stylesheet">
            </noscript>
            <link rel="preload" href="{{ asset('css/datatablesResponsive.css') }}" as="style"
                onload="this.onload=null;this.rel='stylesheet'">
            <noscript>
                <link href="{{ asset('css/datatablesResponsive.css') }}" rel="stylesheet">
            </noscript>
        @endif
    ...
    @endif
    <!-- Google fonts - Roboto -->
    <link rel="preload" href="{{ asset('css/googlefontapis.css') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
...
<body
            ...
            <span class="brand-big">
                @if ($general_setting->site_logo)
                    <a href="{{ url('/') }}"><img src="{{ url('logo', $general_setting->site_logo) }}"
                            width="115" style="mix-blend-mode: multiply"></a>
                @else
                    <a href="{{ url('/') }}">
    ...
    <div class="page {{ $sidebar ? '' : 'active' }}">
        <!-- navbar-->
        @if (Route::current()->getName() != 'sale.pos')
            <header class="container-fluid">
                <nav class="navbar">
                    <a id="toggle-btn" href="#" class="menu-btn" {!! !$sidebar ? 'style="opacity: 0;"' : '' !!}><i
        ...
        <div id="warehouse-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{ trans('Branch Report') }}</h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
        ...
        <div id="stock-transfer-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{ trans('Stock Transfer') }}</h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="warehouse_id" class="selectpicker form-control" required
                                data-live-search="true" id="warehouse_id_stock_transfer"
                        ...
                        <div class="form-group">
                            <button id="warehouse_stock_transfer_submit"
    ...
    <script type="text/javascript">
        ...
        var warehouse_stock_transfer_id = null;
        $("#warehouse_id_stock_transfer").on("change", function() {
            warehouse_stock_transfer_id = $(this).val();
            console.log(warehouse_stock_transfer_id);
        });

        $("#warehouse_stock_transfer_submit").on("click", function() {
            if (warehouse_stock_transfer_id == null) {
                alert('Please select a Branch First');
                return false;
            } else {
                window.location.href = "stock-trannsfer/" + warehouse_stock_transfer_id;
            }
        });
        ...
        $("a#stock-transfer").click(function(e) {
            e.preventDefault();
