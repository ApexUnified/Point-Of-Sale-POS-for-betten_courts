                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="col-md-6 offset-md-3 mt-3 text-center">
                            ...
                            <p>Select Branch to view chart</p>
                            <select class="form-control mb-3" id="warehouse_id" name="warehouse_id">
                                <option value="0">{{ trans('All Branches') }}</option>
                        ...
                        <div class="col-md-6 offset-md-3 mt-3 mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h2><strong>{{ number_format((float) $total_item, $general_setting->decimal, '.', '') }}</strong>
                                    </h2>
                                </div>
                                <div class="col-md-6">
                                    <span>Total {{ trans('file.Quantity') }}</span>
                                    <h2><strong>{{ number_format((float) $total_qty, $general_setting->decimal, '.', '') }}</strong>
                                    </h2>
                                </div>
                            </div>
                        </div>
