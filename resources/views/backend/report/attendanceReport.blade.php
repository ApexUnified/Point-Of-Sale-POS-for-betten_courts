...
@if(!empty($start_date) && !empty($end_date)  && $attendances->isEmpty())
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('Attendance Report')}}</h3>
            </div>
            {!! Form::open(['route' => 'attendance.report', 'method' => 'GET']) !!}
            <div class="row mb-3">
        ...
        <table id="report-table" class="table table-hover">
            ...
            <tbody class="text-center">
               ...
               <tr>
                        ...
                        <td>{!! nl2br(e($attendance->times)) !!}</td>
                        <td>{{ $attendance->employees->getShifts()->pluck('shift')->implode(',') }}</td>
...
<script type="text/javascript">
    ...
    $("ul#report #attendance-report-menu").addClass("active");
