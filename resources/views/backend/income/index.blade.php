                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        $(':checkbox:checked').each(function (i) {
                                if (i) {  // Skip the first checkbox as it may be the header checkbox
                                    var selected_id = $(this).closest('tr').data('income_id');
                                    if (selected_id) {
                                        income_id.push(selected_id);  // Collect income IDs
                                    }
                                }
                            });
                            console.log("Selected Income IDs: ", income_id);
