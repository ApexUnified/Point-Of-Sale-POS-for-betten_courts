                        ...
                        <div class="card-body">
                            ...
                            <form id="product-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('Product Selling Price') }} *</strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('Daily Sale Target') }}</strong> </label>
                                    ...
                                    <div class="col-md-12 mt-2" id="diffPrice-option">
                                        @if ($lims_product_data->is_diffPrice)
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice"
                                                    value="1" checked>&nbsp;
                                                {{ trans('file.This product has different price for different Branches') }}
                                            </h5>
                                        @else
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice"
                                                    value="1">&nbsp;
                                                ...
                                                <div class="selected_items">
                                                    @foreach ($related_products as $product)
                                                        ...
                                                        <div data-id="{{ $product->id }}"><img
                                                                src="{{ asset('public/images/product/small/') }}/{{ $image[0] }}">
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                ...
                                $('.search_result').append('<div data-id="' + value.id +
                                    '"><img src="{{ asset('public/images/product/small/') }}/' +
