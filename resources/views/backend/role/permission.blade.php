						        ...
						        <tr class="hrm-row">
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("out_of_shift", $all_permission))
							                    	<input type="checkbox" value="1" id="out_of_shift" name="out_of_shift" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="out_of_shift" name="out_of_shift">
							                    	@endif
								                    <label for="out_of_shift" class="padding05">{{trans('out_of_shift')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
										...
										<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("zkteco_configuration", $all_permission))
							                    	<input type="checkbox" value="1" id="zkteco_configuration" name="zkteco_configuration" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="zkteco_configuration" name="zkteco_configuration">
							                    	@endif
								                    <label for="zkteco_configuration" class="padding05">{{trans('ZkTeco Configuration')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
