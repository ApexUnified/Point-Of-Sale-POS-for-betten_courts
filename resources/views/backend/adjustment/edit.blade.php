                                                    ...
                                                    <tbody>
                                                        @foreach ($lims_product_adjustment_data as $product_adjustment_data)
                                                            <tr>
                                                                ...
                                                                <td>{{ $product->name }}</td>
                                                                <td>{{ $product->code }}</td>
                                                                <td>{{ $product_adjustment_data->unit_cost }}<input
                                                                        type="hidden" name="unit_cost[]"
                                                                        value="{{ $product_adjustment_data->unit_cost }}" />
                                                                </td>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        cols += '<td>' + data[0] + '</td>';
                        cols += '<td>' + data[1] + '</td>';
                        cols += '<td>' + data[4] + '<input type="hidden" name="unit_cost[]" value="' + data[4] +
                            '" /></td>';
                        cols +=
