        ...
        'columnDefs': [
            ...
            },
            {
                'render': function(data, type, row, meta){
                    if(type === 'display'){
                        // Assuming `row.id` contains the customer ID, add it to `data-id`
                        data = '<div class="checkbox"><input type="checkbox" class="dt-checkboxes" data-id="' + row.id + '"><label></label></div>';
                    }
                    return data;
                },
                'checkboxes': {
            ...
            
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        $(':checkbox.dt-checkboxes:checked').each(function() {
                            let id = $(this).data('id');  
                            if (id) {
                                customer_id.push(id);
                            }
