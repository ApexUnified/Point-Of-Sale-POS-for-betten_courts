...
<body>
    ...
    <div style="max-width:290px;margin:0 auto">
        ...
        <div class="hidden-print">
            <table>
                <tr>
                    <td><a href="{{ route('sale.pos') }}" class="btn btn-info"><i class="fa fa-arrow-left"></i>
        ...
        <div id="receipt-data">
            <div class="centered">
                @if ($warehouse->image)
                    <img src="{{ asset('images/warehouse_images/' . $warehouse->image) }}" height="42" width="50"
                        style="margin:10px 0;">
                @endif

                <h2>{{ $lims_biller_data->company_name ?? 'No Company Name Given' }}</h2>
            ...
            <p>{{ trans('file.Date') }}:
                ...
                Biller Name : {{ $lims_biller_data->name ?? 'No Biller Name Given ' }} <br>
                Time : {{ $lims_sale_data->created_at->format('g:i A') }} <br>
            ...
            <table>
                <tbody>
                    ...
                    <td class="centered" colspan="3">
                        ...
                        <br>
                        <?php echo '<img style="margin-top:10px;" src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('order.invoice', $lims_sale_data->id), 'QRCODE') . '" alt="QRcode"   />'; ?>
                    </td>
                    </tr>
                </tbody>
            </table>
