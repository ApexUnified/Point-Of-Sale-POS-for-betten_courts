...
@section('css')
    <style>
        @media all and (max-width:1200px) {
            ...
            .navbar-header #today-profit-btn {
                display: none;
            }

            .navbar-header #today-sale-btn {
                display: none;
            }
    ...
    <section class="forms pos-section">
        <div class="container-fluid">
            <div class="row">
                ...
                <div
                    class="col-md-{{ in_array('category', json_decode($general_setting->display_section, true)) ? '6' : '7' }}">
                    <div class="card">
                ...
                <!-- product list -->
                <div
                    class="col-md-{{ in_array('category', json_decode($general_setting->display_section, true)) ? '4' : '5' }}">
                    <!-- navbar-->
                    <header>
                        <nav class="navbar">
                    ...
                    <div class="row text-center justify-content-center">
                        ...
                        @if (in_array('brand', json_decode($general_setting->display_section, true)))
                            <div class="col-md-4">
                        ...
                        @if (in_array('featured', json_decode($general_setting->display_section, true)))
                            <div class="col-md-4">
...
@push('scripts')
    <script type="text/javascript">
                ...
                $.each(data['name'], function(index) {
                    ...
                    if (index % 3 == 0 && index != 0) {
                        tableData += '</tr><tr><td class="product-img sound-btn" title="' + data['name'][index] +
                            '" data-product = "' + product_info + '"><img  src="public/images/product/' + image +
        ...
        $('select[name="warehouse_id"]').on('change', function() {
            ...
            $.get('sales/getproduct/' + warehouse_id, function(data) {
                ...
                for (rowindex = 0; rowindex <= rownumber; rowindex++) {
                    var row_product_code = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')')
                        .find('.product-code').val();
        ...
        function calculateGrandTotal() {
            ...
            console.log("POS Order TAX: " + order_tax);
