                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="company_name" class="form-control"
                                            value="@if ($lims_general_setting_data) {{ $lims_general_setting_data->company_name }} @endif" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="vat_registration_number" class="form-control"
                                            value="@if ($lims_general_setting_data) {{ $lims_general_setting_data->vat_registration_number }} @endif" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="decimal"
                                            value="@if ($lims_general_setting_data) {{ $lims_general_setting_data->decimal }} @endif"
                                            max="6" min="0">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="display_section[]" class="selectpicker form-control" multiple>
                                            <option value="category"
                                                {{ in_array('category', json_decode($lims_general_setting_data->display_section, true)) ? 'selected' : '' }}>
                                                Category</option>
                                            <option value="brand"
                                                {{ in_array('brand', json_decode($lims_general_setting_data->display_section, true)) ? 'selected' : '' }}>
                                                Brand</option>
                                            <option value="featured"
                                                {{ in_array('featured', json_decode($lims_general_setting_data->display_section, true)) ? 'selected' : '' }}>
                                                Featured</option>
                                        </select>
