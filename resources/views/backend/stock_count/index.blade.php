            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a  href="{{asset('stock_count/'.$stock_count->initial_file)}}" title="{{trans('file.Download')}}" download ><i class="dripicons-copy"></i></a>
                    </td>
                    <td class="text-center">
                        @if($stock_count->final_file)
                        <a  href="{{asset('stock_count/'.$stock_count->final_file)}}" title="{{trans('file.Download')}}" download><i class="dripicons-copy"></i></a>
                        @endif
                    </td>
                    <td>
                        @if($stock_count->final_file)
